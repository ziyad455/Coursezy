        ...
        <div class="flex justify-center">
            <div class="w-full max-w-md">
                ...
                <div class="text-center mb-8">
                    ...
                    <h2 class="mt-2 text-2xl font-bold text-gray-800 dark:text-dark-text-primary">Create your account
                    </h2>
                ...
                <div class="mt-6 text-center text-sm text-light-text-muted dark:text-dark-text-muted">
                    By registering, you agree to our <a href="#"
                        class="text-indigo-600 dark:text-indigo-400 hover:underline">Terms</a> and <a href="#"
                        class="text-indigo-600 dark:text-indigo-400 hover:underline">Privacy Policy</a>.
                </div>
            </div>
        </div>
    </div>
