        ...
        <div class="flex justify-center">
            <div class="w-full max-w-md">
                ...
                <div class="text-center mb-8">
                    ...
                    <h2 class="mt-2 text-2xl font-bold text-gray-800 dark:text-dark-text-primary">Create your account</h2>
                ...
                <div class="bg-light-bg-secondary dark:bg-dark-bg-secondary rounded-xl shadow-lg overflow-hidden border border-light-border-default dark:border-dark-border-default transition-all duration-300">
                    <div class="p-6 sm:p-8">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <!-- Name -->
                            <div class="mb-5">
                                <label for="name" class="block text-sm font-medium text-light-text-secondary dark:text-dark-text-secondary mb-1">
                                    {{ __('Name') }}
                                </label>
                            ...
                            <!-- Confirm Password -->
                            <div class="mb-6">
                                <label for="password_confirmation" class="block text-sm font-medium text-light-text-secondary dark:text-dark-text-secondary mb-1">
                                    {{ __('Confirm Password') }}
                                </label>
