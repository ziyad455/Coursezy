        ...
        <div class="flex justify-center">
            <div class="w-full max-w-md">
                ...
                <div class="bg-light-bg-secondary dark:bg-dark-bg-secondary rounded-xl shadow-lg overflow-hidden border border-light-border-default dark:border-dark-border-default transition-all duration-300">
                    <div class="p-6 sm:p-8">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <!-- Password -->
                            <div class="mb-5">
                                <label for="password" class="block text-sm font-medium text-light-text-secondary dark:text-dark-text-secondary mb-1">
                                    {{ __('Password') }}
                                </label>
                            ...
                            <div class="flex items-center justify-between mb-6">
                                <label for="remember_me" class="inline-flex items-center">
                                    <input id="remember_me" type="checkbox" 
                                           ...
                                           name="remember">
                                    <span class="ms-2 text-sm text-light-text-secondary dark:text-dark-text-secondary">{{ __('Remember me') }}</span>
                                </label>

                                @if (Route::has('password.request'))
                                    <a href="{{ route('password.request') }}" class="text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 transition-colors duration-300">
                        ...
                        <div class="relative my-6">
                            <div class="absolute inset-0 flex items-center">
                                <div class="w-full border-t border-light-border-default dark:border-dark-border-default"></div>
                            </div>
                            <div class="relative flex justify-center text-sm">
                                <span class="px-2 bg-light-bg-secondary dark:bg-dark-bg-secondary text-light-text-muted dark:text-dark-text-muted">
                                    Or continue with
                                </span>
                            </div>
                        </div>
                ...
                <div class="mt-6 text-center text-sm text-light-text-muted dark:text-dark-text-muted">
                    Don't have an account? <a href="{{ route('register') }}" class="text-indigo-600 dark:text-indigo-400 hover:underline font-medium">Sign up</a>
                </div>
            </div>
        </div>
    </div>
