        ...
        <div class="flex justify-center">
            <div class="w-full max-w-md">
                ...
                <div class="text-center mb-8">
                    ...
                    <h2 class="mt-2 text-2xl font-bold text-gray-800 dark:text-white">Welcome back</h2>
                            ...
                            <div class="flex items-center justify-between mb-6">
                                <label for="remember_me" class="inline-flex items-center">
                                    <input id="remember_me" type="checkbox" 
                                           class="rounded border-gray-300 dark:border-gray-600 text-indigo-600 focus:ring-indigo-500 dark:bg-gray-700 dark:focus:ring-indigo-600 transition-colors duration-300"
                                           name="remember">
