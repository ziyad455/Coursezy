...
<head>
    ...
    <title>Forgot Password - Coursezy</title>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div class="flex justify-center">
            <div class="w-full max-w-md">
                ...
                <!-- Info Text -->
                <div
                    class="mb-6 text-sm text-light-text-secondary dark:text-dark-text-secondary bg-blue-50 dark:bg-blue-900/30 p-4 rounded-lg">
