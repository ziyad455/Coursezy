...
<body class="bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-indigo-900 min-h-screen text-light-text-primary dark:text-dark-text-primary transition-colors duration-300">
    <!-- Welcome Message -->
    <div id="welcomeMessage" class="fixed inset-0 flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-indigo-900 z-50 transition-colors duration-300">
        ...
        <div class="max-w-4xl w-full">
            ...
            <form action="{{ route('roll.store') }}"  method="POST" id="roleForm">
                ...
                <div class="grid md:grid-cols-2 gap-8 mb-12">
                    <!-- Student Card -->
                    <div class="role-card card-hover relative bg-light-bg-secondary dark:bg-dark-bg-secondary rounded-2xl p-8 border-2 border-light-border-default dark:border-dark-border-default cursor-pointer group transition-colors duration-300" data-role="student">
                        <input type="radio" name="roll" id="student" value="student" class="sr-only">
                        
                        <div class="text-center">
                            <!-- Student Icon -->
                            <div class="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30 rounded-full flex items-center justify-center group-hover:from-blue-200 group-hover:to-indigo-200 dark:group-hover:from-blue-800/40 dark:group-hover:to-indigo-800/40 transition-colors duration-300">
                            ...
                            <h3 class="text-2xl font-bold text-light-text-primary dark:text-dark-text-primary mb-3">Student</h3>
                        ...
                        <!-- Selection Indicator -->
                        <div class="absolute top-4 right-4 w-6 h-6 rounded-full border-2 border-light-border-default dark:border-dark-border-default flex items-center justify-center transition-all duration-300">
                            <div class="w-3 h-3 bg-light-accent-secondary dark:bg-indigo-400 rounded-full opacity-0 scale-0 transition-all duration-300"></div>
                        </div>
                    </div>

                    <!-- Coach Card -->
                    <div class="role-card card-hover relative bg-light-bg-secondary dark:bg-dark-bg-secondary rounded-2xl p-8 border-2 border-light-border-default dark:border-dark-border-default cursor-pointer group transition-colors duration-300" data-role="coach">
                        <input type="radio" name="roll" id="coach" value="coach" class="sr-only">
                        
                        <div class="text-center">
                            <!-- Coach Icon -->
                            <div class="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-purple-100 to-pink-100 dark:from-purple-900/30 dark:to-pink-900/30 rounded-full flex items-center justify-center group-hover:from-purple-200 group-hover:to-pink-200 dark:group-hover:from-purple-800/40 dark:group-hover:to-pink-800/40 transition-colors duration-300">
                            ...
                            <h3 class="text-2xl font-bold text-light-text-primary dark:text-dark-text-primary mb-3">Coach</h3>
                            <p class="text-light-text-secondary dark:text-dark-text-secondary leading-relaxed">
                        ...
                        <!-- Selection Indicator -->
                        <div class="absolute top-4 right-4 w-6 h-6 rounded-full border-2 border-light-border-default dark:border-dark-border-default flex items-center justify-center transition-all duration-300">
                            <div class="w-3 h-3 bg-purple-600 dark:bg-purple-400 rounded-full opacity-0 scale-0 transition-all duration-300"></div>
                        </div>
                    </div>
                </div>
