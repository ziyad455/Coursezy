...
<body class="bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-indigo-900 min-h-screen text-gray-900 dark:text-gray-100 transition-colors duration-300">
    <!-- Welcome Message -->
        ...
        <div class="max-w-4xl w-full">
            ...
            <form action="{{ route('roll.store') }}"  method="POST" id="roleForm">
                ...
                <div class="grid md:grid-cols-2 gap-8 mb-12">
                    <!-- Student Card -->
                    <div class="role-card card-hover relative bg-white dark:bg-gray-800 rounded-2xl p-8 border-2 border-gray-200 dark:border-gray-700 cursor-pointer group transition-colors duration-300" data-role="student">
                        ...
                        <div class="text-center">
                            ...
                            <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-3">Student</h3>
                        ...
                        <!-- Selection Indicator -->
                        <div class="absolute top-4 right-4 w-6 h-6 rounded-full border-2 border-gray-300 dark:border-gray-600 flex items-center justify-center transition-all duration-300">
                            <div class="w-3 h-3 bg-indigo-600 dark:bg-indigo-400 rounded-full opacity-0 scale-0 transition-all duration-300"></div>
                        </div>
                    </div>

                    <!-- Coach Card -->
                    <div class="role-card card-hover relative bg-white dark:bg-gray-800 rounded-2xl p-8 border-2 border-gray-200 dark:border-gray-700 cursor-pointer group transition-colors duration-300" data-role="coach">
                        ...
                        <div class="text-center">
                            ...
                            <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-3">Coach</h3>
                            <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
        ...
        roleCards.forEach(card => {
            card.addEventListener('click', () => {
                ...
                roleCards.forEach(c => {
                    ...
                    border.classList.add('border-gray-300', 'dark:border-gray-600');
                });
                ...
                border.classList.remove('border-gray-300', 'dark:border-gray-600');
