...
<head>
    ...
    <title>Coach Dashboard - {{ config('app.name', 'Laravel') }}</title>
...
<body
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 mb-8">
            <!-- Total Courses Card -->
            <div
                class="bg-light-bg-secondary dark:bg-dark-bg-secondary rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 overflow-hidden border border-light-border-subtle dark:border-dark-border-subtle p-6">
            ...
            <div
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-light-text-primary dark:text-dark-text-primary"
                        id="totalStudents">{{ number_format($totalStudents) }}</p>
                </div>
            </div>
            ...
            <div
                ...
                <div>
                    <p class="text-sm font-medium text-light-text-secondary dark:text-dark-text-secondary mb-1">Total
                        Revenue</p>
                    <p class="text-2xl font-bold text-light-text-primary dark:text-dark-text-primary" id="totalRevenue">
        ...
        <div
            class="bg-light-bg-secondary dark:bg-dark-bg-secondary rounded-xl shadow-md border border-light-border-subtle dark:border-dark-border-subtle p-6 mb-8">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-xl font-semibold text-light-text-primary dark:text-dark-text-primary">Recent Activity
                </h2>
                <span id="newActivityBadge"
                    class="hidden px-2 py-1 bg-red-500 text-dark-text-primary text-xs rounded-full animate-pulse">New</span>
            </div>
            <div class="space-y-4" id="activityList">
                @forelse($recentActivities as $activity)
                    <div class="activity-item flex items-center space-x-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg {{ !$activity->is_read ? 'border-l-4 border-indigo-500' : '' }}"
                ...
                @empty
                    <div class="text-center py-8 text-light-text-muted dark:text-dark-text-muted">
                        <svg class="w-12 h-12 mx-auto mb-4 text-gray-300 dark:text-light-text-secondary" fill="none"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <!-- Create New Course -->
            <div
                class="bg-gradient-to-br from-indigo-500 to-indigo-600 dark:from-indigo-600 dark:to-indigo-700 rounded-xl p-6 text-dark-text-primary">
                <div class="flex items-center justify-between mb-4">
                ...
                <button
                    class="px-4 py-2 bg-light-bg-secondary/20 hover:bg-light-bg-secondary/30 text-dark-text-primary rounded-lg text-sm font-medium transition-colors">
                    Get Started
                </button>
            </div>
            ...
            <!-- Manage Students -->
            <div
                class="bg-gradient-to-br from-green-500 to-green-600 dark:from-green-600 dark:to-green-700 rounded-xl p-6 text-dark-text-primary">
                <div class="flex items-center justify-between mb-4">
                ...
                <p class="text-green-100 text-sm mb-4">View enrollments, track progress, and communicate with students
                </p>
                <button
                    class="px-4 py-2 bg-light-bg-secondary/20 hover:bg-light-bg-secondary/30 text-dark-text-primary rounded-lg text-sm font-medium transition-colors">
                    View Students
            ...
            <!-- Analytics -->
            <div
                class="bg-gradient-to-br from-purple-500 to-purple-600 dark:from-purple-600 dark:to-purple-700 rounded-xl p-6 text-dark-text-primary">
                <div class="flex items-center justify-between mb-4">
