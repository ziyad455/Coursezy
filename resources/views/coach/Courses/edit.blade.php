...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
    ...
    <main class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            ...
            <nav class="flex mb-4" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    <li class="inline-flex items-center">
                        <a href="{{ route('coach.courses.index') }}" class="inline-flex items-center text-sm font-medium text-gray-500 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-indigo-400 transition-colors">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-500 dark:text-gray-400">Edit Course</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-2 animate-fade-in-up">
                        Edit Course
                    </h1>
                    <p class="text-lg text-gray-600 dark:text-gray-300 animate-fade-in-up" style="animation-delay: 0.1s;">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden animate-fade-in-up" style="animation-delay: 0.2s;">
                    ...
                    <div class="p-8">
                        <form id="courseForm" class="space-y-8" action="{{ route('coach.courses.update', $course) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="space-y-2">
                                <label for="title" class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Course Title *</label>
                                <div class="relative">
                                    <input type="text" id="title" name="title" required maxlength="100"
                                           class="w-full px-4 py-4 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white transition-all duration-300 text-lg font-medium"
                            ...
                            <div class="space-y-2">
                                <label for="description" class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Course Description *</label>
                                <div class="relative">
                                    <textarea id="description" name="description" rows="6" required maxlength="2000"
                                              class="w-full px-4 py-4 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white transition-all duration-300 resize-none"
                            ...
                            <div class="space-y-2">
                                <label for="price" class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Course Price *</label>
                                <div class="relative">
                                    <span class="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-500 dark:text-gray-400 text-lg font-medium">$</span>
                                    <input type="number" id="price" name="price" step="0.01" min="0" max="9999.99" required
                                           class="w-full pl-10 pr-4 py-4 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white transition-all duration-300 text-lg font-medium"
                                           placeholder="99.99" 
                                ...
                                <div id="price-feedback" class="text-xs text-gray-500 dark:text-gray-400"></div>
                                @error('price')
                                    <div class="flex items-center mt-2 text-sm text-red-600 animate-slide-in">
                                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                            ...
                            <div class="space-y-2">
                                <label for="category_id" class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Category *</label>
                                <select id="category_id" name="category_id" required
                                        class="w-full px-4 py-4 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white transition-all duration-300 text-lg appearance-none bg-white dark:bg-gray-700">
                            ...
                            <div class="space-y-3">
                                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Course Status *</label>
                                <div class="grid grid-cols-2 gap-4">
                                    <label class="relative cursor-pointer">
                                        <input type="radio" name="status" value="draft" 
                                               {{ old('status', $course->status) == 'draft' ? 'checked' : '' }}
                                               class="sr-only peer">
                                        <div class="p-4 border-2 border-gray-300 dark:border-gray-600 rounded-xl transition-all duration-300 peer-checked:border-yellow-500 peer-checked:bg-yellow-50 dark:peer-checked:bg-yellow-900/20 hover:border-yellow-400">
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <p class="text-xs text-gray-500 dark:text-gray-400">Save for later editing</p>
                                                </div>
                                            </div>
                                        </div>
                                    </label>
                                    ...
                                    <label class="relative cursor-pointer">
                                        <input type="radio" name="status" value="published" 
                                               ...
                                               class="sr-only peer">
                                        <div class="p-4 border-2 border-gray-300 dark:border-gray-600 rounded-xl transition-all duration-300 peer-checked:border-green-500 peer-checked:bg-green-50 dark:peer-checked:bg-green-900/20 hover:border-green-400">
                                            <div class="flex items-center space-x-3">
                                                <div class="flex-shrink-0">
                                                ...
                                                <div class="flex-1">
                                                    <h3 class="text-sm font-medium text-gray-900 dark:text-white">Published</h3>
                                                    <p class="text-xs text-gray-500 dark:text-gray-400">Make it live for students</p>
                                                </div>
                                            </div>
                                        </div>
                                    </label>
                            ...
                            <div class="flex items-center justify-between pt-8 border-t border-gray-200 dark:border-gray-700">
                                ...
                                <div class="flex items-center space-x-4">
                                    <a href="{{ route('coach.courses.index') }}" class="px-6 py-3 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-medium rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-300">
                                        Cancel
                                    </a>
                                    <button type="submit" id="submit-btn" class="inline-flex items-center px-8 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-medium rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300">
                                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                        </svg>
            ...
            <div class="lg:col-span-1 space-y-6">
                <!-- Current Thumbnail -->
                @if($course->thumbnail)
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden animate-fade-in-up" style="animation-delay: 0.3s;">
                    <div class="bg-gradient-to-r from-purple-500 to-pink-600 px-4 py-3">
                        <h3 class="text-sm font-semibold text-white">Current Thumbnail</h3>
                    </div>
                    <div class="p-4">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden animate-fade-in-up" style="animation-delay: 0.4s;">
                    ...
                    <div class="p-4">
                        <div id="upload-area" class="relative border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-xl p-6 text-center hover:border-indigo-500 dark:hover:border-indigo-400 transition-all duration-300 cursor-pointer group">
                            ...
                            <div id="upload-content" class="space-y-3">
                                <div class="mx-auto w-12 h-12 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center group-hover:bg-indigo-50 dark:group-hover:bg-indigo-900/20 transition-colors">
                                    <svg class="w-6 h-6 text-gray-400 group-hover:text-indigo-500 dark:group-hover:text-indigo-400" stroke="currentColor" fill="none" viewBox="0 0 48 48">
                ...
                <!-- Course Statistics -->
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden animate-fade-in-up" style="animation-delay: 0.5s;">
                    ...
                    <div class="p-4 space-y-4">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-lg font-semibold text-gray-900 dark:text-white">{{ $course->enrollments_count ?? 0 }}</span>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-lg font-semibold text-gray-900 dark:text-white">{{ $course->average_rating ?? 'N/A' }}</span>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-lg font-semibold text-gray-900 dark:text-white">{{ $course->views_count ?? 0 }}</span>
                        </div>
                        
                        <div class="pt-3 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center justify-between">
                                <span class="text-sm text-gray-600 dark:text-gray-400">Created</span>
                                <span class="text-sm font-medium text-gray-900 dark:text-white">{{ $course->created_at->format('M j, Y') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Quick Actions -->
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden animate-fade-in-up" style="animation-delay: 0.6s;">
                    ...
                    <div class="p-4 space-y-3">
                        <a href="#" class="flex items-center p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors group">
                            ...
                            <span class="ml-3 text-sm font-medium text-gray-700 dark:text-gray-300">Preview Course</span>
                        </a>
                        ...
                        <a href="#" class="flex items-center p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors group">
                            ...
                            <span class="ml-3 text-sm font-medium text-gray-700 dark:text-gray-300">Manage Lessons</span>
                        </a>
                        ...
                        <a href="#" class="flex items-center p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors group">
                            ...
                            <span class="ml-3 text-sm font-medium text-gray-700 dark:text-gray-300">View Analytics</span>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div id="delete-modal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-xl bg-white dark:bg-gray-800">
            <div class="mt-3 text-center">
                ...
                <h3 class="text-lg font-medium text-gray-900 dark:text-white mt-4">Delete Course</h3>
                ...
                <div class="flex items-center justify-center space-x-4 mt-6">
                    <button onclick="hideDeleteConfirmation()" class="px-4 py-2 bg-gray-300 dark:bg-gray-600 text-gray-800 dark:text-gray-200 text-sm font-medium rounded-lg hover:bg-gray-400 dark:hover:bg-gray-500 transition-colors">
                        Cancel
                    </button>
    ...
    <!-- Success Toast -->
    <div id="success-toast" class="hidden fixed top-4 right-4 bg-green-500 text-white px-6 py-3 rounded-lg shadow-lg z-50 animate-bounce-in">
        <div class="flex items-center">
            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
            </svg>
    ...
    <script>
        ...
        function validatePrice(input) {
            ...
            if (value === 0) {
                ...
                feedback.className = 'text-xs text-gray-500 dark:text-gray-400';
            } else if (value >= 100) {
