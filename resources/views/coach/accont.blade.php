...
<body
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form action="/accont" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div
                class="bg-light-bg-secondary dark:bg-dark-bg-secondary rounded-xl shadow-md border border-light-border-subtle dark:border-dark-border-subtle p-6 opacity-0 animate-fade-in stagger-1">
                <h2 class="text-xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-6">Profile
                    Picture</h2>
            ...
            <div
                class="bg-light-bg-secondary dark:bg-dark-bg-secondary rounded-xl shadow-md border border-light-border-subtle dark:border-dark-border-subtle p-6 opacity-0 animate-fade-in stagger-4">
                <h2 class="text-xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-6">Professional
                    Information</h2>
                ...
                <div>
                    ...
                    <div id="skills-container"
                        class="flex flex-wrap gap-2 min-h-[50px] p-3 border-2 border-dashed border-light-border-default dark:border-dark-border-default rounded-lg">
                        @forelse(Auth::user()->skills ?? [] as $skill)
                            <span
                                class="skill-tag inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-indigo-100 dark:bg-indigo-900/30 text-indigo-800 dark:text-indigo-200 border border-indigo-200 dark:border-indigo-700">
                                {{ $skill->name }}
                        ...
                        @empty
                            <p class="text-light-text-muted dark:text-dark-text-muted text-sm">No skills added yet. Add your
                                first skill above.</p>
                        @endforelse
                    </div>
