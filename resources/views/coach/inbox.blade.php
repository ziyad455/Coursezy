...
<body class="bg-light-bg-primary dark:bg-dark-bg-primary text-light-text-primary dark:text-dark-text-primary transition-colors duration-300">
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6">
            <h2 class="text-sm font-semibold text-light-text-muted dark:text-dark-text-muted uppercase tracking-wide mb-3 px-2">
                Pinned
            </h2>
            <a href="/ai" class="block bg-light-bg-secondary dark:bg-dark-bg-secondary rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-light-border-subtle dark:border-dark-border-subtle p-4 mb-6 hover:bg-light-bg-tertiary dark:hover:bg-dark-bg-tertiary/50">
                <div class="flex items-center space-x-4">
                    <!-- AI Assistant Icon -->
                    <div class="relative">
                        <div class="w-14 h-14 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full flex items-center justify-center">
                            <svg class="w-8 h-8 text-dark-text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center justify-between mb-1">
                            <h3 class="text-lg font-semibold text-light-text-primary dark:text-dark-text-primary truncate">
                                AI Assistant
                            </h3>
        ...
        <div>
            ...
            <div class="space-y-2">
                ...
                <a href="/conversation/1" class="block bg-light-bg-secondary dark:bg-dark-bg-secondary rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-light-border-subtle dark:border-dark-border-subtle p-4 hover:bg-light-bg-tertiary dark:hover:bg-dark-bg-tertiary/50">
                    <div class="flex items-center space-x-4">
                        <!-- Profile Picture -->
                        <div class="relative">
                            <img class="w-14 h-14 rounded-full object-cover border-2 border-gray-200 dark:border-dark-border-default" 
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center justify-between mb-1">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <!-- Unread indicator -->
                                    <div class="w-3 h-3 bg-light-accent-secondary dark:bg-dark-accent-secondary rounded-full"></div>
                                </div>
                            </div>
                            <p class="text-sm text-light-text-secondary dark:text-dark-text-secondary truncate">
                ...
                <!-- Contact 2: Mike Chen -->
                <a href="/conversation/2" class="block bg-light-bg-secondary dark:bg-dark-bg-secondary rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-light-border-subtle dark:border-dark-border-subtle p-4 hover:bg-light-bg-tertiary dark:hover:bg-dark-bg-tertiary/50">
                    <div class="flex items-center space-x-4">
                        <!-- Profile Picture -->
                        <div class="relative">
                            <img class="w-14 h-14 rounded-full object-cover border-2 border-gray-200 dark:border-dark-border-default" 
                ...
                <a href="/conversation/3" class="block bg-light-bg-secondary dark:bg-dark-bg-secondary rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-light-border-subtle dark:border-dark-border-subtle p-4 hover:bg-light-bg-tertiary dark:hover:bg-dark-bg-tertiary/50">
                    <div class="flex items-center space-x-4">
                        <!-- Profile Picture -->
                        <div class="relative">
                            <img class="w-14 h-14 rounded-full object-cover border-2 border-gray-200 dark:border-dark-border-default" 
