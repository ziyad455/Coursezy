...
<x-studentNav/>
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form action="/student/accont" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="bg-light-bg-secondary dark:bg-dark-bg-secondary rounded-xl shadow-md border border-light-border-subtle dark:border-dark-border-subtle overflow-hidden opacity-0 animate-fade-in stagger-1">
                <div class="p-6 sm:p-8">
                    <h2 class="text-xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-2">Profile Picture</h2>
                    <p class="text-sm text-light-text-secondary dark:text-dark-text-secondary mb-6">Update your profile photo to personalize your account</p>
