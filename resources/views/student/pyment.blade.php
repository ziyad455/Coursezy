...
<body class="bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-indigo-900 text-gray-900 dark:text-gray-100 font-sans min-h-screen">
    <!-- Navigation Bar -->
    <x-studentNav/>
    ...
    <main class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-16">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div class="lg:col-span-2 animate-slide-up">
                <div class="glass-effect rounded-2xl card-shadow border border-white/20 dark:border-gray-700/50 p-8 lg:p-10">
            ...
            <div class="animate-slide-up" style="animation-delay: 0.2s;">
                <div class="glass-effect rounded-2xl card-shadow border border-white/20 dark:border-gray-700/50 p-8 sticky top-8">
                    ...
                    <div class="mb-8">
                        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-600 overflow-hidden">
                            ...
                            <div class="p-4">
                                <h3 class="font-bold text-gray-900 dark:text-white text-lg mb-2 line-clamp-2">{{ $course->title }}</h3>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center space-x-3 text-sm">
                                ...
                                <span class="text-gray-600 dark:text-gray-400">Lifetime access to course content</span>
                            </div>
                            <div class="flex items-center space-x-3 text-sm">
                                <i class="fas fa-certificate text-blue-500"></i>
                                <span class="text-gray-600 dark:text-gray-400">Certificate of completion</span>
                            </div>
                            <div class="flex items-center space-x-3 text-sm">
                                <i class="fas fa-mobile-alt text-blue-500"></i>
                                <span class="text-gray-600 dark:text-gray-400">Mobile and desktop access</span>
                            </div>
                            <div class="flex items-center space-x-3 text-sm">
                                <i class="fas fa-headset text-blue-500"></i>
                                <span class="text-gray-600 dark:text-gray-400">24/7 student support</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="mt-16 text-center animate-fade-in" style="animation-delay: 0.4s;">
            <div class="max-w-4xl mx-auto">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-8">Trusted by thousands of students worldwide</h3>
    ...
    <!-- Footer -->
    <footer class="relative bg-gradient-to-r from-gray-900 to-gray-800 text-white mt-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="text-center">
                ...
                <p class="text-gray-400 text-sm mb-2">© 2025 Coursezy. All rights reserved.</p>
                <p class="text-gray-500 text-xs">Secure payments powered by industry-leading encryption</p>
            </div>
        </div>
    </footer>
