    ...
    <div class="space-y-2">
        @forelse($users as $user)
            ...
            <a href="{{ url('/chating/' . $user->id) }}" 
               class="block bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 dark:border-gray-700 p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                <div class="flex items-center space-x-4">
                    <!-- Profile Picture -->
                    <div class="relative">
        ...
        @empty
            ...
            <div class="flex flex-col items-center justify-center py-16 px-6 text-center bg-white dark:bg-gray-800 rounded-xl border-2 border-dashed border-gray-200 dark:border-gray-700">
                <!-- Icon -->
