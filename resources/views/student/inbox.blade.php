...
<div>
    ...
    <div class="space-y-2">
        ...
        @empty
            ...
            <div class="flex flex-col items-center justify-center py-16 px-6 text-center bg-light-bg-secondary dark:bg-dark-bg-secondary rounded-xl border-2 border-dashed border-light-border-default dark:border-dark-border-default">
                <!-- Icon -->
                <div class="w-20 h-20 mx-auto mb-6 flex items-center justify-center rounded-full bg-gray-100 dark:bg-gray-700">
                    <svg class="w-10 h-10 text-gray-400 dark:text-light-text-muted" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <p class="text-light-text-muted dark:text-dark-text-muted mb-6 max-w-sm leading-relaxed">
                    Start a conversation with someone to see your chat history here. Your recent messages will appear in this space.
                </p>
