            ...
            @else
                ...
                <div class="flex-1 flex items-center justify-center bg-gray-50 dark:bg-gray-900">
                    <div class="text-center max-w-md mx-auto p-8">
                        ...
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-3">Welcome to {{ $course->title }}</h2>
                        <p class="text-gray-600 dark:text-gray-400 mb-6">Select a lesson from the sidebar to begin your learning journey</p>
