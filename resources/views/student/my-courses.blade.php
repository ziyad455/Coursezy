...
<body
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
            <div
                class="bg-light-bg-secondary dark:bg-dark-bg-secondary rounded-xl shadow-md p-6 border border-light-border-subtle dark:border-dark-border-subtle">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-light-text-secondary dark:text-dark-text-secondary">Total Courses</p>
                        <p class="text-2xl font-bold text-light-text-primary dark:text-dark-text-primary">
                            {{ $enrollments->total() }}</p>
                    </div>
        ...
        @if($enrollments->count() > 0)
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                @foreach($enrollments as $enrollment)
                    ...
                    @endphp
                    <div
                        class="bg-light-bg-secondary dark:bg-dark-bg-secondary rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 overflow-hidden border border-light-border-subtle dark:border-dark-border-subtle animate-fade-in-up">
                        <!-- Course Thumbnail -->
                        <div class="relative h-48 bg-gradient-to-br from-indigo-500 to-purple-600">
                            ...
                            @else
                                <div class="flex items-center justify-center h-full">
                                    <svg class="w-16 h-16 text-dark-text-primary/50" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                                    </svg>
                            ...
                            <!-- Progress Badge -->
                            <div
                                class="absolute top-2 right-2 px-3 py-1 bg-black/50 backdrop-blur-sm rounded-full text-xs text-dark-text-primary">
                                In Progress
                            </div>
                        </div>
                        ...
                        <div class="p-5">
                            ...
                            <div class="mb-3">
                                <h3
                                    class="text-lg font-semibold text-light-text-primary dark:text-dark-text-primary mb-1 line-clamp-2">
                                    {{ $course->title }}
                                </h3>
                                @if($course->category)
                                    <span
                                        class="inline-block px-2 py-1 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 text-xs rounded-full">
                            ...
                            <div class="border-t border-light-border-default dark:border-dark-border-default pt-4">
                                <p class="text-sm text-light-text-secondary dark:text-dark-text-secondary mb-2">Rate this
                                    course:</p>
                                <div class="star-rating" data-course-id="{{ $course->id }}"
                                    data-current-rating="{{ $userRating }}">
                                    @for($i = 1; $i <= 5; $i++)
        ...
        @else
            ...
            <div class="bg-light-bg-secondary dark:bg-dark-bg-secondary rounded-xl shadow-md p-12 text-center">
                <svg class="w-24 h-24 mx-auto text-gray-300 dark:text-light-text-secondary mb-6" fill="none"
                    stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
                <h3 class="text-xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-2">No courses yet
                </h3>
                <p class="text-light-text-secondary dark:text-dark-text-secondary mb-6">Start your learning journey by
    ...
    <div id="reviewModal" class="hidden fixed inset-0 z-50 overflow-y-auto">
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div
                class="relative bg-light-bg-secondary dark:bg-dark-bg-secondary rounded-xl max-w-md w-full p-6 shadow-xl">
                <h3 class="text-xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-4">Write a
                    Review</h3>
                <p class="text-sm text-light-text-secondary dark:text-dark-text-secondary mb-4" id="reviewCourseTitle">
                </p>
                ...
                <form id="reviewForm">
                    ...
                    <div class="mb-4">
                        <label
                            class="block text-sm font-medium text-light-text-secondary dark:text-dark-text-secondary mb-2">Your
                            Rating</label>
    ...
    <!-- Success Toast -->
    <div id="successToast"
        class="hidden fixed bottom-4 right-4 bg-green-500 text-dark-text-primary px-6 py-3 rounded-lg shadow-lg transform transition-all duration-300 translate-y-full">
