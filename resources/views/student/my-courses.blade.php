...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        @if($enrollments->count() > 0)
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                @foreach($enrollments as $enrollment)
                    ...
                    @endphp
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 overflow-hidden border border-gray-100 dark:border-gray-700 animate-fade-in-up">
                        <!-- Course Thumbnail -->
                        <div class="relative h-48 bg-gradient-to-br from-indigo-500 to-purple-600">
                            ...
                            <!-- Progress Badge -->
                            <div class="absolute top-2 right-2 px-3 py-1 bg-black/50 backdrop-blur-sm rounded-full text-xs text-white">
                                In Progress
                            </div>
                        </div>
                        ...
                        <div class="p-5">
                            ...
                            <div class="border-t border-gray-200 dark:border-gray-700 pt-4">
                                <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">Rate this course:</p>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-2" id="rating-message-{{ $course->id }}">
                                    @if($userRating > 0)
                            ...
                            <div class="flex gap-2 mt-4">
                                <a href="{{ route('cours.details', $course->id) }}" 
                                   class="flex-1 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg text-center transition-colors">
                                    Continue Learning
                                </a>
        ...
        @else
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-12 text-center">
                ...
                <p class="text-gray-600 dark:text-gray-400 mb-6">Start your learning journey by enrolling in a course</p>
    ...
    <div id="reviewModal" class="hidden fixed inset-0 z-50 overflow-y-auto">
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-xl max-w-md w-full p-6 shadow-xl">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mb-4" id="reviewCourseTitle"></p>
    ...
    <!-- Success Toast -->
    <div id="successToast" class="hidden fixed bottom-4 right-4 bg-green-500 text-white px-6 py-3 rounded-lg shadow-lg transform transition-all duration-300 translate-y-full">
