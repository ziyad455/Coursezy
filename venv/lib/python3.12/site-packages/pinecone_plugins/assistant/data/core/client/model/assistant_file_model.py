...
class AssistantFileModel(ModelNormal):
    ...
    def _from_openapi_data(cls, name, id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            signed_url (str, none_type): A [signed URL](https://cloud.google.com/storage/docs/access-control/signed-urls) that provides temporary, read-only access to the underlying file. Anyone with the link can access the file, so treat it as sensitive data. Expires after a short time. [optional]  # noqa: E501
            ...
            multimodal (bool): Indicates whether the file was processed as multimodal. [optional]  # noqa: E501
        """
